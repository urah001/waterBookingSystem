                            ...
                            <div class="card card-outline-primary">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT * FROM vendors ORDER BY rs_id DESC";
                                            $query = mysqli_query($db, $sql);

                                            if (!mysqli_num_rows($query) > 0) {
                                                echo '<td colspan="12"><center>No Vendors</center></td>';
                                            } else {
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    ...
                                                    echo '<tr>
                                                        ...
                                                        <td>' . $rows['o_days'] . '</td>
                                                        <td>' . $rows['address'] . '</td>
                                                        <td><center><img src="Res_img/' . $rows['image'] . '" class="img-responsive radius" style="min-width:150px;min-height:100px;" /></center></td>
                                                        <td>' . $rows['date'] . '</td>
                                                        <td>
                                                            <a href="delete_vendor.php?res_del=' . $rows['rs_id'] . '" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o"></i></a>
                                                            <a href="update_vendor.php?res_upd=' . $rows['rs_id'] . '" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
                                                        </td>
                                                    </tr>';
                                                }
                                            }
