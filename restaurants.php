...
<header id="header" class="header-scroll top-header headrom">
    <nav class="navbar navbar-dark">
        <div class="container">
            ...
            <a class="navbar-brand" href="index.php"><img class="img-rounded" src="images/icn.png" alt="Logo"></a>
        ...
        <div class="bottom-footer">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                    <h5>Why Choose Us</h5>
                    <p>Trusted by thousands for quick and clean water delivery services. Book anytime from nearby vendors.</p>
                </div>
            </div>
        </div>
    </div>
